...
ここ最近の クラス 6 維持ボーダーの履歴は上記のとおりでした。**次週 6/20 は、536,000 点がボーダーラインになると予想されます**。

6/20 のボーダーラインは 365 点ダウンし、530,729。ついに前回のボーダーより減少となりました。現環境では 53 万点がボーダーに落ち着く気配を見せています。

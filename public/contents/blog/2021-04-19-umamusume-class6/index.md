...
（※ 2021/4/25 現在のクラス 6 維持を念頭に書いています。4/25 追記しました。）
...
- **対戦相手は常に A ランクを選ぶ**。賢さとスピードに尖っている人がいれば、パフェを使って全力勝負する
...
| コース         | 逃げ         | 先行         | 差し・追込   |
| -------------- | ------------ | ------------ | ------------ |
| 短距離         | SS+/C+/A/D/D | SS/C+/A+/D/D | S+/C+/S/D/D  |
| マイル・ダート | SS/B/A/D/D   | S+/B/A+/D/D  | S/B/S/D/D    |
| 中距離         | S+/B+/B+/D/D | S/B+/A/D/D   | A+/B+/A+/D/D |
| 長距離         | S/A/B/C/D    | A+/A/B+/C/D  | A/A/A/C/D    |

（4/25: パラメータを更新）

目標ステータスは、上位ランカーのステータスを参考に決めています。実際の上位ランカーは、この 2 段階上のパラメータです！　無〜微課金のサポカプールだと難しいので、育成での上振れを祈りましょう！

**スタミナは距離の 1/3 を目指します**。中距離であれば 2400m が最大ですから、800 が最大目標になります。特に中長距離のスタミナ不足はラストスパート距離の長さに関係していると耳にしていますので、そうであればかなり大事ですね。

**どんな脚質であれ、パワーの要求値は高めに見ておいたほうが良い印象です**。実際にレースを見てみると、パワーが足りない場合、番手がとれなくなったり、前が捌けなかったり、ラストスパートの加速が足りなかったりなど、結構負けに響いている印象です。
...
| 距離           | 育成優先度 | デッキ構成                      | 因子継承 |
| -------------- | ---------- | ------------------------------- | -------- |
| 短距離         | SP>PW>賢   | SP / SP / SP / SP / PW / たづな | PW > ST  |
| マイル・ダート | SP>PW>賢   | SP / SP / SP / PW / PW / ※      | ST > PW  |
| 中距離         | SP>ST>PW   | SP / SP / SP / PW / PW / ※      | ST > PW  |
| 長距離         | ST>SP>PW   | SP / SP / ST / ST / ST / ※      | PW > SP  |
...
**継承する青因子は、サポートカードで選ばなかった 3 種類目を選びます**。基本的に ST9 を選び、長距離は PW9 を選ぶ感じになります。短距離については ST を余らせても仕方ないので、こちらも PW9 を選びましょう。
...
具体的な数字でいうと、育成 78 週間のうち 18 レース出て、1/3 をお休みすると、**40 回程度しかトレーニングできないことになります**。Lv5 のトレーニングを引き出すためには 16 回の事前トレーニングが必要なので、Lv5 で友情 3 人トレーニングを複数回狙えるのは実質 1 種類目のみです。2 種類目は A までいければ優秀ですね。

逆に**夏合宿は上の 2 種類以外、特に賢さトレーニング**を中心に行います。賢さは D が必須で、それ以上は戦績の安定性に少しずつ寄与するイメージなので、一発狙いの無課金者にとっては過剰な取得はコストが高くなると思います。また、中距離についてはスタミナが不足しやすいので補ってあげるなど、通常のトレーニングでは不足するようなところを選択していきます。
...
ここ最近の CLASS6 維持ボーダーの履歴は上記のとおりでした。おおよそ 50 万点を稼げば良いことになっています。

...
- **全角のスペース**が紛れ込んでいませんか？
  - 文頭や文末が、特に怪しいです
- **プロジェクトの作成手順**を間違えませんでしたか？
  - 『[開発環境を整える](./01-setup)』のページを見て、もう一度作り直してみてください

[[exercise | 練習問題: エラーを起こしてみる]]
| 1. `"Hello, World!\n"` の右端の `"` を削除して、エラーを起こしてみてください
| 2. `return 0;` の前のインデントを全角スペースにして、エラーを起こしてみてください

[[details | コラム: "デキる" プログラマになるには？]]
| デキるプログラムを書ける人は、「**他人が見てもすぐ理解できるソースコード**」を記述する能力があります。ソースコードを見せただけでプログラムを理解してもらうために、今でもできることとして以下のものがあります；
|
